...
<!-- Page top section -->
<form method="post" action='<c:url value="/addGame"/>'>
    <!-- Content Row -->
    <div class="row">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <input class="form-control" type="text" name="rating"
                                   placeholder="Ocena gry z przedziału 1-100">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-10">
                            <select name="file">
                                <option selected="default-game.png" value="default-game.png">Domyślny obrazek</option>
                                <option hidden>Wybierz obrazek ze źródła</option>
